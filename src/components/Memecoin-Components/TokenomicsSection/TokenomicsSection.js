...
// Import images
import Bg from '../../../images/shapes/memecoin_bg_shape_4.svg'
import presaleIcon from '../../../images/shapes/shape_tokenomics_orange.png';
import liquidityIcon from '../../../images/shapes/shape_tokenomics_pink.png';
import marketingIcon from '../../../images/shapes/shape_tokenomics_light_green.png';
import communityIcon from '../../../images/shapes/shape_tokenomics_light_blue.png';
import developmentIcon from '../../../images/shapes/shape_tokenomics_light_yellow.png';
import teamIcon from '../../../images/shapes/shape_tokenomics_light_pink.png';
import arrowIcon from '../../../images/shapes/shape_arrow_right.png';
import casinoImage from '../../../images/about/casino_image.png';
...
const TokenomicsSection = () => {
    ...
    return (
        <section id='meme_tokenomics_section' className="meme_tokenomics_section" style={{ backgroundImage: `url(${Bg})` }}>
                    ...
                    <div className="row align-items-center">
                            ...
                            <div className="meme_tokenomics_distribution" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100">
                                ...
                                <ul className="unordered_list_block">
                                    {[ 
                                        ...
                                        <li key={index}>
                                            <div className="icon">
                                                <img src={item.icon} alt={`Shape Tokenomics ${item.title}`} />
                                            </div>
                                            <div className="value">
                        ...
                        <div className="col-lg-2">
                            <div className="shape_arrow_right" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="200">
                                <img src={arrowIcon} alt="Icon Arrow Right" />
                            </div>
                        </div>
