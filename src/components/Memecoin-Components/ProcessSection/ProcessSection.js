...
// Import images
import backgroundImage from "../../../images/shapes/memecoin_bg_shape_3.svg";
import shapeNetImage from "../../../images/shapes/shape_net_2.svg";
import cartoonImage from "../../../images/shapes/shape_cartoon_4.png";
import btnMaskBg from "../../../images/shapes/btn_mask_bg.png";
import crownImage from "../../../images/shapes/shape_crown.png";
import ironmanReactorImage from "../../../images/shapes/shape_ironman_reactor.svg";
...
const processSteps = [
  {
    ...
    description:
      "Visit the Buy page to purchase Meme $BOLT securely and join the crypto community today!",
    number: "1",
    delay: "100",
  },
  {
  ...
  {
    title: "Buy $BOLT token",
    description:
      "Buy $BOLT Token now and join the growing community shaping the future of crypto!",
    number: "3",
    delay: "300",
  },
];
    ...
    >
      <div className="container">
        <div
          ...
          style={{ backgroundImage: `url(${shapeNetImage})` }}
          data-aos="fade-up"
          ...
          <div className="row align-items-center justify-content-lg-between">
            <div className="col-lg-7">
              <div className="memecoin_heading_block">
                <h2 className="heading_text text-uppercase">
                  How To Buy <mark>Meme</mark> $BOLT Token
                </h2>
                <p className="heading_description mb-0 pe-lg-5">
                  Set up a wallet, buy ETH/BNB, connect to a DEX, swap for Meme
                  $BOLT, and confirm the transaction.
                </p>
              </div>
              <Link className="memecoin_btn bg-white" to="/token" onClick={ClickHandler}>
            ...
            <div className="col-lg-4">
              <div className="cartoon_image">
                <img src={cartoonImage} alt="Meme Cartoon" />
              </div>
            </div>
          </div>
        </div>
