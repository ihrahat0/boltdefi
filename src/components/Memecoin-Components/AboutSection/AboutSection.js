...
// Import images
import aboutMemecoinImage from "../../../images/about/about_memecoin.png";
import aboutMemecoin2Image from "../../../images/about/about_memecoin_2.png";
import shapeNetImage from "../../../images/shapes/shape_net.svg";
    ...
    return (
        <section id="id_about_memecoin_section" className="about_memecoin_section section_space section_decoration">
                ...
                <div className="row">
                    <div className="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <div className="image_block" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                            <img src={aboutMemecoinImage} alt="Cartoon" />
                        </div>
                    </div>
                    <div className="col-lg-6 text-lg-center">
                        <div className="meme_popup_video_area">
                            ...
                            <div className="image_block" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                                <img src={aboutMemecoin2Image} alt="Cartoon" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="decoration_item shape_net_top">
                <img src={shapeNetImage} alt="Shape Net" />
            </div>
