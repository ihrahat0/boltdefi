...
import Bg from '../../../images/shapes/btn_mask_bg.png'
import shapeCartoon1 from '../../../images/shapes/shape_cartoon_5.png';
import shapeCartoon2 from '../../../images/shapes/shape_cartoon_6.png';
import shapeCartoon3 from '../../../images/shapes/shape_cartoon_7.png';
    ...
    <footer className="meme_site_footer section_decoration">
      <div className="container">
        ...
        >
          ...
          <li>
            <Link to="id_token_offer" spy={true} smooth={true} duration={500} offset={-100}>
              <span className="pagelist_label">About $BOLT</span>
            </Link>
          </li>
          <li>
        ...
        >
          <li>
            <NavLink className="memecoin_btn bg-white" to="/token" onClick={ClickHandler}>
          ...
          <li>
            <NavLink className="memecoin_btn bg-light" to="/token" onClick={ClickHandler}>
      ...
      <div className="decoration_item cartoon_shape_1">
        <img src={shapeCartoon1} alt="Cartoon" />
      </div>
      <div className="decoration_item cartoon_shape_2">
        <img src={shapeCartoon2} alt="Cartoon" />
      </div>
      <div className="decoration_item cartoon_shape_3">
        <img src={shapeCartoon3} alt="Cartoon" />
      </div>
    </footer>
  );
};
